...
Create a landing page for NeetCode following this detailed description:
...
```sh
git clone https://github.com/GPT-Engineer-App-Dev/neetcode-navigate.git
cd neetcode-navigate
npm i
```
